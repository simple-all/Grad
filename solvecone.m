...
% See cone.m
[sol]=ode15s(@cone2,[thetasr 1e-10],y0,options,gamma);
...
% ?c 2009 Dr. J. V. Lassaline 4 of 6 Updated: March 13, 2009
% Ryerson University AE 8121 High-Speed Aerodynamics Winter 2009
...
% igure 6: Matlab source code for cone.m
    function [value,isterminal,direction]=coneevent(theta,y,gamma)
        ...
        % cone solution for point where vtheta=0
        % - current angle
